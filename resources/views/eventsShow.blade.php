<x-main-layout>
    <section class="bg-white dark:bg-gray-800">
        <div class="m-2 p-2 flex justify-between">
            <h3 class="mb-4 text-2xl font-bold text-indigo-700">Event Name: {{ $event->title }}</h3>
            <div class="flex space-x-2 text-white">
                From:
                <span class="mx-2 text-white">{{ $event->start_date->format('m/d/Y') }}</span> | <span class="mx-2">{{ $event->end_date->format('m/d/Y') }}</span>
            </div>
        </div>
        <div class="flex flex-wrap">
            <div class="w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pr-6">
                <div class="flex flex-col">
                    ...
                    <div class="flex space-x-2 p-4" x-data="{
                        ...
                        <button type="button" @click="onHandleLike" class="text-white  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2
                        dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" :class="eventLike ? 'dark:bg-red-700 dark:hover:bg-red-800' : 'dark:bg-slate-400 dark:hover:bg-slate-500'">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3.5 h3.5 mr-2">
                        ...
                        <button type="button" @click="onHandleSavedEvent" class="text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center
                        dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" :class="savedEvent ? 'dark:bg-yellow-700 dark:hover:bg-yellow-800' : 'dark:bg-slate-400 dark:hover:bg-slate-500'">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3.5 h3.5 mr-2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.25 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0z" />
                            </svg>
                            Save
                        </button>
                        <button type="button" @click="onHandleAttending" class="text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center
                        dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" :class="attending ? 'dark:bg-indigo-700 dark:hover:bg-indigo-800' : 'dark:bg-slate-400 dark:hover:bg-slate-500'">
                            Attending
            ...
            <div class="mb-4 w-full shrink-0 grow-0 lg:w-6/12 lg:pl-6 bg-slate-50 rounded-md p-2">
                ...
                @auth
                <div class="container d-flex justify-content-center align-items-center w-50 mt-6 bg-slate-200 p-4 rounded-md">
                    <div class="">
