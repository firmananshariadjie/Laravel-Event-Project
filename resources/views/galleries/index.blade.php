                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-2">
                                    <a href="{{ route('galleries.edit', $gallery) }}" class="text-green-400 hover:text-green-600">Edit</a>
                                    <p>-</p>
                                    <form method="POST" class="text-red-400 hover:text-red-600" action="{{ route('galleries.destroy', $gallery) }}">
                                        @csrf
                                        @method('DELETE')
